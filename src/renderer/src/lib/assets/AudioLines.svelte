<script lang="ts">
  ...
  let isAnimatingBack: boolean = $state(false);
  let startPositions: StartPositions | null = $state(null);

  type Lines = `line${1 | 2 | 3 | 4 | 5 | 6}`;
  type StartPositions = Record<Lines, KeyFrames[number]>;
  const originalPositions: StartPositions = {
    line1: { y1: 10, y2: 13 },
    line2: { y1: 6, y2: 17 },
    line3: { y1: 3, y2: 21 },
    line4: { y1: 8, y2: 15 },
  ...
  type KeyFrames = Array<{ y1: number; y2: number }>;
  const line1Keyframes: KeyFrames = [
    { y1: 10, y2: 13 },
    { y1: 5, y2: 18 },
    { y1: 8, y2: 15 },
    { y1: 6, y2: 17 },
  ...
  const line2Keyframes: KeyFrames = [
    { y1: 6, y2: 17 },
    { y1: 2, y2: 22 },
    { y1: 10, y2: 13 },
    { y1: 6, y2: 17 },
  ...
  const line3Keyframes: KeyFrames = [
    { y1: 3, y2: 21 },
    { y1: 6, y2: 17 },
    { y1: 3, y2: 21 },
    { y1: 8, y2: 15 },
  ...
  const line4Keyframes: KeyFrames = [
    { y1: 8, y2: 15 },
    { y1: 4, y2: 19 },
    { y1: 7, y2: 16 },
    { y1: 2, y2: 22 },
  ...
  const line5Keyframes: KeyFrames = [
    { y1: 5, y2: 18 },
    { y1: 10, y2: 13 },
    { y1: 4, y2: 19 },
    { y1: 8, y2: 15 },
  ...
  const line6Keyframes: KeyFrames = [
    { y1: 10, y2: 13 },
    { y1: 8, y2: 15 },
    { y1: 5, y2: 18 },
    { y1: 10, y2: 13 },
  ...
  function interpolateKeyframes(keyframes: KeyFrames, progress: number) {
...
>
  <svg
    ...
    class:animate={isHovered || animated}
  >
